...
install_basics_from_package_manager() {
	sudo apt install firefox fish curl htop btop wget git make g++ gcc python3 python3-pip sshfs entr imagemagick w3m neomutt urlscan gnupg2 pass wl-clipboard vlc audacity grim slurp wl-copy swappy
}
